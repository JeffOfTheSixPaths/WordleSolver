...
public class SolverController {
    ...
    Algorithm entropy = new EntropyAlg(thing, thing);
    ...
    public void initialize() {
        ...
        System.out.println("NEXT BEST GUESS " + entropy.bestGuess());
    }
    ...
    public void onSubmitGuess() {
        ...
        String pattern = "";
        for(letter_color c : colors){
            if(c.equals(letter_color.GREEN)) pattern += "2";
            else if(c.equals(letter_color.YELLOW)) pattern += "1";
            else if(c.equals(letter_color.RED)) pattern += "0";
        }
        entropy.applyPattern(guess, pattern);
        entropy.feedback.add(guess);
        System.out.println("NEXT BEST GUESS " + entropy.bestGuess());
    ...
    private void resetGame() {
        ...
        // this is just used to reset the wordlist
        System.out.println("RESET");
        ArrayList<String> thing = (ArrayList<String>) new LoadWordlist().getWords();
        entropy = new EntropyAlg(thing, thing);
        // reset chosen word
